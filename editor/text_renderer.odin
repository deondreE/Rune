...
// 	w, h := ttf.GetStringSize(tr.font, text_cstr, len(text_cstr))
// 	return w, h, true
// }

// get_char_position_from_pixel :: proc(
// 	tr: ^Text_Renderer,
// 	text: string,
// 	pixel_x: int,
// 	allocator: mem.Allocator = context.allocator,
...
// 		char_str := text[i:i + size]
// 		if w, _, ok := measure_text(tr, char_str, allocator); ok {
// 			if current_x + w / 2 > pixel_x {
// 				break
// 			}
// 			current_x += w
// 		} else {
// 			current_x += tr.char_width // Fallback
// 		}
